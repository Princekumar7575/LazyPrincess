...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Prince_xt')
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Prince_xt') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','MOVIE_WORLD_NETWORKK') # WITHOUT @
